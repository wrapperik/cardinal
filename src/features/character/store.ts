/**
 * Character selection is disabled — the home screen's wheel
 * (@/features/home/character-wheel) is commented out to match, and
 * @/app/quiz.tsx renders the puck as the fixed default character instead of
 * reading from this store. Commented out wholesale rather than deleted so
 * re-enabling the feature is a matter of uncommenting this file, the wheel,
