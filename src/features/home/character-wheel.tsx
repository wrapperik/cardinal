/**
 * The character selector, held out of the home screen for now. See
 * @/features/character/store (also commented out) and its call site in
 * @/app/home.tsx. Commented out wholesale rather than deleted so
 * re-enabling the feature is a matter of uncommenting this file and its
 * call sites.
 */
